...
@WebServlet("/FetchAddhaar")
public class FetchAddhaar extends  HttpServlet{
  ...
  response) throws ServletException, IOException{
	  ...
	  try{
	      ...
	      PreparedStatement ps = con.prepareStatement("select addhaar from uploaddocument where acount=?");
	     
	      ps.setLong(1,Acount_number);
	      ResultSet rs = ps.executeQuery();
	     
	      if(rs.next()){
	          Blob photo = rs.getBlob("addhaar");
