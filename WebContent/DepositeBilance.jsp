      ...
      <div class="row">
        <div class="col-sm-4">
          ...
          <h4>Deposit Balance  </h4>
            ...
            Enter amount : <input type="text" name="amounts"/>
            
            <button type="submit" class="btn btn-primary">Submit</button>
			<button type="reset" class="btn btn-primary" align="right">Clear</button> 
